...
<body>
    ...
    <div class="uk-child-width-expand@s" uk-grid>
        <div>
            ...
            <h3 class="uk-heading-line"><span>Pendentes</span></h3>
                ...
                <?php
                    ...
                    foreach($linhas as $l) {
                        echo "
                            ...
                            <dd>Endereço: ".$l['endereco']." <a class='uk-button uk-button-link uk-button-small' id='btnRed' href='inativarCliente.php?cpf=".base64_encode($l['cpf'])."'>Inativar</a></dd>                        
                        ";
                    }
                ?>
            </dl>
                ...
                <?php
                    ...
                    foreach($linhas as $l) {
                        echo "
                            <dt>".$l['nome']." (Cpf ".$l['cpf'].")</dt>
                            <dd>Nascimento: ".$l['nascimento']." Sexo: ".$l['sexo']." Estado Civil: ".$l['estadoCivil']."</dd>
                            <dd>Endereço: ".$l['endereco']." <a class='uk-button uk-button-link uk-button-small' href='ativarCliente.php?cpf=".base64_encode($l['cpf'])."'>Ativar</a></dd>                        
                        ";
                    }
                ?>
            </dl>
