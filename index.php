...
<body>
    ...
    <div class="uk-child-width-expand@s uk-text-center" uk-grid>
        ...
        <div>
            ...
            <h1>EJuri</h1>
            <p>Gestão automatizada de processos eletrônicos</p>
            ...
            <div class="uk-grid-column-small uk-grid-row-large uk-child-width-1-2@s uk-text-center" uk-grid>
                ...
                <div>
                    ...
                    <form action="index.php" method="post">
                        <fieldset class="uk-fieldset">
                            <div class="uk-margin">
                                <input class="uk-input uk-form-width-medium" type="number" min=1 max=9999999999 required name="cod" placeholder="Código">
                            </div>
                            <div class="uk-margin">
                                <input class="uk-input uk-form-width-medium" type="password" maxlength="5" required name="senhaJu" placeholder="Senha">
                            </div>
                            <div class="uk-margin">
                                <button class="uk-button uk-button-default" type="submit">Entrar</button>
                            </div>
